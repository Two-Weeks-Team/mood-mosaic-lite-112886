...
> One‑click daily mood logging with a simple heat‑map view.

---

## Overview

People want a quick, private way to see how their emotions change over time, but existing tools are either overly complex or require cloud accounts.
...
```yaml
name: mood-mosaic-lite
services:
  - name: api
    github:
      repo: Two-Weeks-Team/mood-mosaic-lite
      branch: master
